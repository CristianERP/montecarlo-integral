...
int main()
{
  ...
  {
    for (size_t m1_idx = 0; m1_idx < 5 + N_ASTEROIDS; m1_idx++) // se toma una partícula de referencia, m1_idx es el índice de esa partícula
    {
    ...
    for (size_t entity_idx = 0; entity_idx < 5 + N_ASTEROIDS; entity_idx++)
    {
